...
<body>
    ...
    <div class="add-post container container-high">
        ...
        <form action="addpost.php" method="post" class="form-add-post" enctype="multipart/form-data">
            <input name="post-title" type="text" class="post-title" placeholder="Назва посту" aria-label="Назва посту">
            <label for="content">Вміст посту</label>
            <textarea class="post-content" name="post-content" id="content"></textarea>
            ...
            <button name="post-create" type="" class="submit-btn">Додати пост</button>
        </form>
    </div>
