...
<body>
    ...
    <div class="add-post container container-high">
        ...
        <form action="addads.php" method="post" class="form-add-post" enctype="multipart/form-data">
            ...
            <textarea class="post-content" name="ad-content" id="content"><?=$ad['content']; ?></textarea>
            <input name="ad-purpose" value="<?=$ad['purpose']; ?>" type="text" class="post-title" placeholder="Призначення посту (КВ-04)" aria-label="Назва посту">
            <br><?php include "./errorinfo.php"; ?>
            <button name="ad-edit" type="" class="submit-btn">Зберегти</button>
        </form>
    </div>
