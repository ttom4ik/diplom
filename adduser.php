...
<body>
    ...
    <div class="add-post container container-high">
        ...
        <form action="adduser.php" method="post" class="form-add-post" enctype="multipart/form-data">
            <input name="user-name" type="text" class="post-title" placeholder="Ім'я" aria-label="Назва посту">
            <input name="user-surname" type="text" class="post-title" placeholder="Прізвище" aria-label="Назва посту">
            <input name="user-course" type="text" class="post-title" placeholder="Курс" aria-label="Назва посту">
            <input name="user-group" type="text" class="post-title" placeholder="Група" aria-label="Назва посту">
            <input name="user-email" type="text" class="post-title" placeholder="Email" aria-label="Назва посту">
            ...
            <button name="user-create" type="" class="submit-btn">Додати</button>
        </form>
    </div>
